...
library(data.table) # Load data.table package for fread and fwrite
...
CB_202205 <- fread("CitiBike_data/Raw/New_Format/202205-citibike-tripdata.csv")

CB_data = rbind(CB_202106, CB_202107, CB_202108, CB_202109, 
                CB_202110, CB_202111, CB_202112, CB_202201, 
                CB_202202, CB_202203, CB_202204, CB_202205)

fwrite(CB_data, file = "CitiBike_data/202106-202205-citibike-trip-data.csv")
